# --- Day 25: Let It Snow ---
#
# Christmas!  Santa is booting up his weather machine; looks like you
...
# important to them, they reminded you repeatedly), they finally find
# an engineer that remembers how the code system works.
#
# The codes are printed on an infinite sheet of paper, starting in the
# top-left corner.  The codes are filled in by diagonals: starting
...
# are actually generated.  The first code is 20151125.  After that,
# each code is generated by taking the previous one, multiplying it by
...
R, C = open("25.in").read.scan(/\d+/).map(&:to_i)
